...
const LanguageSelector = () => {
  ...
  return (
    <Select
      ...
      value={language}
    >
      <SelectTrigger className="w-full -col-end-1">
...
const SettingsSection = () => {
  ...
  return (
    <section
      id="option"
      className=" px-4 py-2 grid gap-4 grid-cols-2 md:grid-cols-3"
    >
      ...
      <Button
        variant="secondary"
        className="text-gray-500 hover:text-gray-700 underline cursor-pointer hover:opacity-60 col-span-full"
        onClick={() =>
